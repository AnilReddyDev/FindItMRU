  ...
  return (
    <div className="flex flex-col items-center poppins  justify-center  min-h-screen   poppins box-border w-full bg-gradient-to-t from-primary/[0.90] to-primary text-primary-light   ">
      <button
        ...
        className="flex items-center gap-3 w-56 mb-40  bg-google-button-blue rounded-md p-0.5  transition-colors duration-300 hover:bg-google-button-blue-hover"
      >
        ...
        <span className="text-sm font-normal text-white tracking-wider">
          Sign in with Google
        </span>
      </button>
    </div>
